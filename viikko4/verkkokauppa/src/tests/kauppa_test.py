...
class TestKauppa(unittest.TestCase):
    ...
    def test_saatavilla_olevan_ja_loppuneen_tuotteen_ostoksen_paaytyttya_pankin_metodia_tilisiirto_kutsutaan_oikeilla_parametreilla(self):
        # tehdään toteutus saldo-metodille
        def varasto_saldo(tuote_id):
            if tuote_id == 1:
                return 10
    ...
    def test_kauppa_pyytaa_uuden_viitenumeron_jokaiselle_maksutapahtumalle(self):
        ...
        # varmistetaan, että viitegeneraattorin metodia uusi on kutsuttu kerran
    ...
    def test_tuotteen_poistaminen_ostokorista_toimii(self):
        # tehdään toteutus saldo-metodille
        def varasto_saldo(tuote_id):
            if tuote_id == 1:
                return 10
